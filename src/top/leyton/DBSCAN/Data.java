...
public class Data {
    ...
    public static ArrayList<Point> generateSpecialData() {
        ...
        List<CheckinTable> checkinTableList = checkinUtil.QueryCheckin("SELECT * FROM `checkin` WHERE user_id = '2' AND date = '2010-08-26' ORDER BY id DESC");
       // List<CheckinTable> checkinTableList = checkinUtil.QueryCheckin("SELECT * FROM `checkin` WHERE user_id = '0'");
        ...
        while (iterator.hasNext()){
            ...
            points.add(new Point(checkinTable.getLatitude(),checkinTable.getLongitude()));
        }
        return points;
    }
